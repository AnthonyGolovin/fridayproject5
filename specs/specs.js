...
//6. From there 80 would be multiplied in the function by the planets unique year (EX. 80 * .24 = 19.2) and it would take the product and subtract it from the users planet age. (EX. 19.02(lifeExpectancy) - 13.02(myPlanetAge)= specified planets life expectancy.)
